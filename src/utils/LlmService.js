...
class LlmService {
  ...
  async analyzeSubtitleContent(subtitleText, existingConversationId = null) {
    ...
    const prompt = `
###
你现在一位翻译专家，现在正帮我理解一个英语字幕文件，方便我能提前学习难点，我当前是中国英语四级水平，对于英语环境了解优先，请帮我：
1、您的任务是分析给定文本中的语言难点，这些难点可能包括对非母语学习者具有挑战性的词汇、短语、俚语、缩写、简写以及网络用语等，尽可能完整。
2、输出格式为json数组，示例如下：
[
    {
        "type": "Words",
